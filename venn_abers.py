"""
Heavily adapted from https://github.com/ip200/venn-abers

Adds multiprobability outputs to CVAP implementation along with
general code refactoring

Ditched multiclass and general wrapper
"""
...
class VennAbersCV:
    ...
    def predict_proba(self, _x_test):
        ...
        p0_p1 = np.column_stack((1 - geo_mean(1 - p0_stack), geo_mean(p1_stack)))
